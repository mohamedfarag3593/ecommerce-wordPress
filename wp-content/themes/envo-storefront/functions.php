...
if (!function_exists('envo_storefront_generate_construct_footer')) :
    ...
    function envo_storefront_generate_construct_footer() {
        ...
        <div class="footer-credits-text text-center">
            ...
            printf(esc_html__('Proudly powered by %s', 'envo-storefront'), '<a href="' . esc_url(__('https://www.facebook.com/mohamed.farag.33671/', 'envo-storefront')) . '">' . esc_html__('Wordpress', 'envo-storefront') . '</a>');
            ?>
            <span class="sep"> | </span>
            <?php
